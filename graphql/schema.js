  ...
  const GroupMessageType = new GraphQLObjectType({
    name: 'GroupMessage',
    fields: () => ({
      sender : { type: GraphQLString },
  ...
  const Mutation = new GraphQLObjectType({
    ...
    fields: {
        ...
        resolve: async (parent, args, context) => {
          ...
          try {
            ...
            if (userExists) {
              ...
              console.log("Broadcast Message" + JSON.stringify(broadcastMessage))
      ...
      findMessage: {
        ...
        resolve: async (parent, args, context) => {
          ...
          try {
            ...
            return ChatService.findMessage(sender);
      ...
      findgroupMessage: {
        type: new GraphQLList(GroupMessageType),
        args: null,
        resolve: async (parent, args, context) => {
          const { authorization } = context.headers;
          ...
          try {
            ...
            return ChatService.findGroupMessage(sender);
